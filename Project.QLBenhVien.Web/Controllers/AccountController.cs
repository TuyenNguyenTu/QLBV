...
using Project.QLBenhVien.Sessions;
using Project.QLBenhVien.Web.Controllers.Results;
using Project.QLBenhVien.Web.Models;
using Project.QLBenhVien.Web.Models.Account;
...
{
    public class AccountController : QLBenhVienControllerBase
    {
